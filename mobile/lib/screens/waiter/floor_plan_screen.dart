  ...
  Widget _buildMetricsBanner(PosProvider pos) {
    return Container(
      ...
      child: Row(
        ...
        children: [
          _buildMetricItem('Dolu Masa', '${pos.occupiedTablesCount}', AppColors.primary),
          _buildDivider(),
          _buildMetricItem('Hesap İstendi', '${pos.billRequestedCount}', AppColors.info),
          _buildDivider(),
          _buildMetricItem('Boş Masa', '${pos.emptyTablesCount}', AppColors.textMuted),
          _buildDivider(),
          _buildMetricItem(
            'Açık Tutar',
